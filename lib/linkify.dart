...
class MentionText extends LinkifyElement {
  MentionText(String text) : super(text);
  ...
  @override
  bool equals(other) => other is MentionText && super.equals(other);
}
...
abstract class Linkifier {
  ...
  List<LinkifyElement> parse(
      List<LinkifyElement> elements, LinkifyOptions options,String listMentionIds);
}
...
const _mentionLinkifier = MentionLinkifier();
const defaultLinkifiers = [_mentionLinkifier,_urlLinkifier, _emailLinkifier];
...
List<LinkifyElement> linkify(
  ...
  linkifiers.forEach((linkifier) {
    list = linkifier.parse(list, options, listMentionIds);
  });
